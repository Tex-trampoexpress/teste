...
serve(async (req) => {
  ...
  try {
    ...
    const { payment_id }: StatusPagamentoRequest = await req.json()
    ...
    console.log('Status do Mercado Pago:', mpResult)
    ...
    console.log('Status consultado com sucesso:', response)
    ...
    console.error('Erro na função status pagamento:', error)
    return new Response(
      JSON.stringify({ 
