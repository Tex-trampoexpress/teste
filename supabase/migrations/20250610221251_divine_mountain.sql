/*
  # Migração Completa do TEX - Versão Corrigida

  1. Nova Estrutura da Tabela `usuarios`
    - Campos otimizados para o fluxo atual
  ...
  4. Dados de Teste
    - Perfis realistas para validação
*/
...
-- PASSO 2: Agora remover funções sem dependências
...
-- PASSO 3: Remover tabela existente se houver
DROP TABLE IF EXISTS usuarios CASCADE;

-- PASSO 4: Criar tabela usuarios otimizada
...
-- PASSO 5: Criar índices otimizados para performance
...
-- PASSO 7: Criar triggers (após as funções estarem criadas)
...
-- PASSO 8: Função para busca por proximidade
...
-- PASSO 9: Função para busca textual otimizada
...
-- PASSO 10: Habilitar RLS (Row Level Security)
ALTER TABLE usuarios ENABLE ROW LEVEL SECURITY;

-- PASSO 11: Criar políticas de segurança
...
-- PASSO 13: Comentários para documentação
