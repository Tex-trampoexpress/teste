...
-- Comentário
COMMENT ON TABLE usuarios IS 'Tabela usuarios revertida ao estado original - funcionalidades avançadas removidas';

-- Log da reversão
DO $$
BEGIN
  RAISE NOTICE 'Migração de reversão aplicada com sucesso. Funcionalidades avançadas removidas.';
  RAISE NOTICE 'Banco de dados retornado ao estado original.';
END;
$$;